          ...
          <div className="bg-white rounded-2xl shadow-sm border p-8">
            ...
            <form className="space-y-4">
              <div className="space-y-2">
                ...
                <Input id="email" placeholder="name@example.com" type="email" className="rounded-lg" required />
              </div>
              <div className="space-y-2">
                ...
                <Input id="password" placeholder="••••••••" type="password" className="rounded-lg" required />
              </div>
